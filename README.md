...
sword hilts. The atmosphere is extremely oppressive; only the sound of rain can be heard. Suddenly,
a crack of thunder flashes, and both charge simultaneously. A fast-panning profile shot captures
their mud-splattering footsteps. The precise moment their weapons clash, the footage switches to
ultra-slow motion, clearly displaying the ring-shaped shockwaves of rainwater blasted away by the
blades, along with bamboo leaves sliced by sword aura. Normal speed resumes as they land
...
**Source:** [Chraft](https://x.com/chraft_ai) - [Post](https://x.com/chraft_ai/status/2021971858409832507) · _Created: February 12_
...
reactions, their hands doing gear/switch changes, and then back to intense aerial shots. Wind whips
from the fighter jets' wings, and the sounds are intensely loud, showcasing the incredibly intense
and fast-paced action scene which also includes explosions and serious camera shakes along with
fast-moving camera shots. Cinematic quality, 4k, crisp detail, and 24 FPS.
```

→ [View all prompts in this category](prompts/04-action-fight/)
...
**Source:** [BigMotion.ai](https://x.com/BigMotion_ai) - [Post](https://x.com/BigMotion_ai/status/2022090726511980552) · _Created: February 12_

**Prompt:**

```text
"Sailor moon jumping onto the bed and screaming "Girls, we did it!". Sailor Venus appears and says:
...
**Source:** [Mark Gadala-Maria](https://x.com/markgadala) - [Post](https://x.com/markgadala/status/2021985063840403880) · _Created: February 12_
...
**Source:** [otung Emmanuel](https://x.com/otung_emmanuel) - [Post](https://x.com/otung_emmanuel/status/2021724349619700055) · _Created: February 12_
...
flashing red, turbulence shaking the cabin, she sprints forward and straps herself into the
captain’s seat, gripping the controls with determination, sweat on her forehead, quick cuts between
her focused eyes and the shaking dashboard, cut to dramatic exterior aerial shot of the airplane
slicing through storm clouds, lightning illuminating her silhouette inside the cockpit at the
...
**Source:** [CoffeeVectors](https://x.com/CoffeeVectors) - [Post](https://x.com/CoffeeVectors/status/2021713445855355226) · _Created: February 11_

**Prompt:**

```text
Handheld running shot with an overflowing bag of gold coins, jumping into water, and having the
camera follow him underwater.
```

→ [View all prompts in this category](prompts/06-drama-romance/)
...
**Source:** [惜命少女阿昕要出海~](https://x.com/MRongxin7589) - [Post](https://x.com/MRongxin7589/status/2021952831398559882) · _Created: February 12_
...
→ [View all prompts in this category](prompts/07-fantasy/)
...
**Source:** [なぁさん｜AIと働くひとり社長](https://x.com/nasan_0422) - [Post](https://x.com/nasan_0422/status/2021856286237995387) · _Created: February 12_
...
**Source:** [xAi](https://x.com/xai_42) - [Post](https://x.com/xai_42/status/2021637349247951131) · _Created: February 11_
...
**Source:** [Stupifff](https://x.com/Stupifff) - [Post](https://x.com/Stupifff/status/2022068457546895767) · _Created: February 12_
...
- [ByteDance Jianying / CapCut (剪映) Official Site](https://www.jianying.com/) - Official home for Jianying/CapCut products, accounts, and platform entry points.

### Learning & workflow guides
- [Seedance 2.0 How to Use Guide](https://xyq.jianying.com/) - Quick onboarding and hands-on exploration through the creator portal.
- [Seedance API Documentation](https://www.jianying.com/) - Starting point for understanding ecosystem integration and product docs at the official site.

### Utilities (X/Twitter media)
- [publer.com](https://publer.com/) - X/Twitter video downloader (useful for collecting reference clips for prompt breakdowns).
- Support: https://publer.com/help

---

## 15. Contributing

We welcome contributions to this library. If you’ve discovered or created a strong **Seedance 2.0** prompt, please submit it through a **GitHub Issue** - we do not accept direct prompt submissions via Pull Requests.
...
1. Click **Submit New Prompt**  
2. Complete the form with all prompt details (and include an image or video link if available)  
3. Submit the issue and wait for our review  
4. Once approved (we’ll add an **approved** label), your prompt will be published in the README 

---

## Attribution & Credit

Proper credit is essential. Please include a **Source link** to the original creator, and ideally the original post, so attribution is preserved.

> **Note:** Prompt submissions are accepted **only via GitHub Issues** to maintain consistency and quality control.
